...
<body>
    ...
    <div class="grid-wrapper">
        <div class="product-grid-container">
            @forelse ($products as $product)
                <a href="{{ route('detail.Product', $product->id) }}" class="product-card">
                    <div class="product-card-image">
                        <img src="{{ $product->image_url ?? 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/No_image_available.svg/1024px-No_image_available.svg.png' }}" alt="Product Image">
                    </div>
            ...
            @empty
                <p style="padding: 10px;">Produk nggak ditemukan.</p>
            @endforelse
        </div>
    </div>
</body>
