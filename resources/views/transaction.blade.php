...
<style>
    ...
    .page-main-header {
        font-weight: bold;
        font-size: 1.8em; /* Sama dengan keranjang */
        padding-bottom: 30px;
        margin-bottom: 30px;
        ...
        /* --- Akhir Penyesuaian Baru --- */
    }

    /* Gaya untuk ikon pencarian di header */
    .page-main-header .search-icon {
        width: 28px; /* Sesuaikan ukuran ikon */
        height: 28px; /* Sesuaikan ukuran ikon */
        vertical-align: middle; /* Membantu perataan jika tidak pakai flex */
        opacity: 0.7; /* Membuat sedikit transparan */
    }
    ...
    @media (max-width: 768px) {
        ...
        .page-main-header {
            ...
            padding-bottom: 15px;
            margin-bottom: 15px;
            gap: 10px; /* Kurangi jarak pada layar kecil */
        }
        .page-main-header .search-icon {
            width: 22px; /* Sesuaikan ukuran ikon untuk mobile */
            height: 22px; /* Sesuaikan ukuran ikon untuk mobile */
        }
        .transaction-entry {
            margin-bottom: 20px;
            padding-bottom: 20px;
        ...
        <div class="transaction-entry">
            <div class="transaction-item-detail">
                ...
                <div class="transaction-info-group">
                    ...
                    <div class="transaction-line-item">Status Pesanan: Tiba di UEC</div>
