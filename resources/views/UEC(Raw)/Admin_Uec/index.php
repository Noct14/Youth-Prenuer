    ...
    <div id="page-wrapper">
        <div class="dashboard-main-content">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    <h3>Pesanan Masuk</h3>
                    <p class="stat-number"><?php echo $ordersReceived; ?></p>
                </div>
                <div class="stat-card">
                    <h3>Diproses</h3>
                    <p class="stat-number"><?php echo $ordersInProcess; ?></p>
                </div>
                <div class="stat-card">
                    <h3>Dikirim</h3>
                    <p class="stat-number"><?php echo $ordersShipped; ?></p>
                </div>
                <div class="stat-card">
                    <h3>Jumlah Produk</h3>
                ...
                <div class="stat-card">
                    <h3>Saldo di UEC</h3>
                    <p class="stat-number">Rp. <?php echo number_format($uecBalance, 0, ',', '.'); ?></p>
                </div>
                <div class="stat-card">
                    <h3>Saldo yang Diterima</h3>
                    <p class="stat-number">Rp. <?php echo number_format($receivedBalance, 0, ',', '.'); ?></p>
                </div>
            </div>
        </div>
