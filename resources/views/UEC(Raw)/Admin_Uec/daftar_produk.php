...
$ordersInProcess = 5;
$ordersShipped = 2;
$productCount = 2; // This will dynamically update with the number of products below
$uecBalance = 400000;
$receivedBalance = 200000;

// Product data for "Daftar Produk" section
$products = [
    ['name' => 'Boba Melekat Kayak Kamu', 'id' => 1],
    ['name' => 'Yoghurt Strawberry', 'id' => 2],
    // Add more products here if needed
];

// Update productCount based on the actual number of products
    ...
    <div class="container-body">
        ...
        <ul class="product-list">
            ...
            foreach ($products as $product) {
                ...
                echo '<div class="product-image" aria-label="Placeholder image">';
                // SVG for placeholder image, you might want to replace this with an actual image tag
                echo '<svg width="48" height="48" fill="#bbb" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21 19V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2zM8 11.5l2.5 3 3.5-4.5L19 17H5l3-5.5z"/></svg>';
                echo '</div>';
                echo '<div class="product-info">';
                echo '<h3 class="product-title">' . htmlspecialchars($product['name']) . '</h3>';
                echo '<div class="actions">';
                echo '<a href="edit_produk.php?id=' . $product['id'] . '" class="edit-text">Edit</a>'; // Changed to <a> tag for "Edit" as it's a navigation
                echo '<button class="btn-tandai" type="button">Tandai Habis</button>';
                echo '<button class="btn-delete" aria-label="Hapus Produk">';
                // SVG for trash icon
                echo '<svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" width="48px" height="48px"><path d="M 10 2 L 9 3 L 5 3 C 4.4 3 4 3.4 4 4 C 4 4.6 4.4 5 5 5 L 7 5 L 17 5 L 19 5 C 19.6 5 20 4.6 20 4 C 20 3.4 19.6 3 19 3 L 15 3 L 14 2 L 10 2 z M 5 7 L 5 20 C 5 21.1 5.9 22 7 22 L 17 22 C 18.1 22 19 21.1 19 20 L 19 7 L 5 7 z M 9 9 C 9.6 9 10 9.4 10 10 L 10 19 C 10 19.6 9.6 20 9 20 C 8.4 20 8 19.6 8 19 L 8 10 C 8 9.4 8.4 9 9 9 z M 15 9 C 15.6 9 16 9.4 16 10 L 16 19 C 16 19.6 15.6 20 15 20 C 14.4 20 14 19.6 14 19 L 14 10 C 14 9.4 14.4 9 15 9 z"/></svg>';
                echo '</button>';
                echo '</div>';
                echo '</div>';
                echo '</li>';
